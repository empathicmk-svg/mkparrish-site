...
const BOOKS = [
  ...
  { src: 'templates/the-resume-rewrite-kit.md',       out: 'templates/the-resume-rewrite-kit.epub' },
  { src: 'templates/the-clean-resume-template.md',     out: 'templates/the-clean-resume-template.epub' },
