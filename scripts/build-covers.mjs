...
const PRODUCTS = [
  ...
  { raw: '# The Cosmos Starter Kit\n', slug: 'the-cosmos-starter-kit', title: 'The Cosmos Starter Kit', subtitle: 'Your free field guide to numerology & astrology.' },
  ...
  { src: 'templates/the-redesign-playbook.md',        slug: 'the-redesign-playbook' },
  ...
  { src: 'templates/the-brand-deal-room.md',          slug: 'the-brand-deal-room' },
  { src: 'templates/the-ugc-brief-bank.md',           slug: 'the-ugc-brief-bank' },
  { src: 'templates/the-tiktok-shop-sprint.md',       slug: 'the-tiktok-shop-sprint' },
  { src: 'templates/the-repurposing-engine.md',       slug: 'the-repurposing-engine' },
  { src: 'templates/the-ai-content-twin.md',          slug: 'the-ai-content-twin' },
  { src: 'templates/the-creator-owned-funnel.md',     slug: 'the-creator-owned-funnel' },
