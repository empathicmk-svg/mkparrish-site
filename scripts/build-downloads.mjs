  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  @media print {
    ...
    h2 {
      ...
      margin: 0 0 30px;
      border: none;
      break-before: page;          /* each section opens a fresh page */
    }
    h2:first-of-type { break-before: avoid; }   /* first section follows the cover */
    h2::before {
      background: none;
    ...
    /* ── PAGINATION — keep blocks whole, headings attached ── */
