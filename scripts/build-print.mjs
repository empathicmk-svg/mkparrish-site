...
const BOOKS = [
  ...
  { slug: 'her-story-rewritten', src: 'ebooks/scripture/her-story-rewritten.md',
    blurb: 'Eight women of the Bible, the moment everything turned, and what their stories are still saying to yours. Eve, Hagar, Hannah, Ruth, Esther, the woman at the well, Mary Magdalene, and Martha, told as real, unsentimental stories about being seen at the bottom of the page and having everything rewritten from there. Scripture for women of any age, no Bible knowledge required, and for anyone who suspects her own story is not finished.' },
  { slug: 'her-story-rewritten-volume-two', src: 'ebooks/scripture/her-story-rewritten-volume-two.md',
    blurb: 'Eight more women of the Bible, the moment everything turned, and what their courage is still saying to yours. Deborah who led without permission, Rahab who bet on mercy, Abigail who walked into the storm, the woman who reached through the crowd, Mary who said yes to the impossible, Lydia who threw open her doors, Priscilla who taught the teacher, and Naomi who survived the empty season. The companion volume: if the first book was about being found, this one is about what you do once you have been.' },
  { slug: 'the-princess-who-rescued-herself', src: 'ebooks/kids/the-princess-who-rescued-herself.md',
    blurb: 'A bedtime fairytale about writing your own happily ever after. Princess Wren is locked in a tower waiting for a rescue that keeps not coming, until she stops waiting and starts paying attention. A warm, funny, quietly radical read-aloud story, with a note for grown-ups, for the child who is learning that they get to write their own door. The first tale in The Little Rewrites.' },
  { slug: 'the-boy-who-talked-to-the-stars', src: 'ebooks/kids/the-boy-who-talked-to-the-stars.md',
    blurb: 'A bedtime story about a mind that works a little differently, and a world that needs exactly that. Theo lines things up, knows the night sky by heart, and covers his ears when it all gets loud, until a fog threatens the fishing boats and the way his mind works turns out to be the thing that brings everyone home. A tender, affirming tale for autistic and neurodivergent kids. A story from The Little Rewrites.' },
  { slug: 'the-quietest-kid-in-the-kingdom', src: 'ebooks/kids/the-quietest-kid-in-the-kingdom.md',
    blurb: 'A bedtime story about the loud, brave magic of a quiet heart. In a kingdom that loves noise, Posy barely speaks, she listens instead, and when the Great Bell cracks and the finest craftsmen are stumped, the quietest kid in the kingdom is the only one who heard exactly where it was breaking. For every shy and introverted child who has been told to speak up. A story from The Little Rewrites.' },
  { slug: 'the-one-who-sat-alone', src: 'ebooks/kids/the-one-who-sat-alone.md',
    blurb: 'A bedtime story about the new kid, the empty seat, and who we get to become. Juniper moves to a town where everything already has its place, until one ordinary boy is brave enough to cross the yard and sit down beside her, and she learns to pass it on. A story about belonging, empathy, and the quiet power every child has to end someone else\'s loneliness. From The Little Rewrites.' },
  { slug: 'the-girl-who-found-her-words', src: 'ebooks/kids/the-girl-who-found-her-words.md',
    blurb: 'A bedtime story about a voice that takes its time, and the day everyone finally listened. Willa is full of stories, but when she speaks they catch and stick behind her teeth, and her impatient kingdom stops listening, until a grey forgetting steals everyone\'s stories and the only one who still remembers is the girl who learned to hold hers carefully. A tender tale for kids who stutter or are shy of speaking: your words are worth waiting for. From The Little Rewrites.' },
  { slug: 'the-kid-with-two-homes', src: 'ebooks/kids/the-kid-with-two-homes.md',
    blurb: 'A bedtime story about a heart that is big enough for two houses. Sam has two homes and a small heavy question, which one is real, and did he cause the one house to become two? A gentle, honest story that does not pretend the family changes back, but tells a truer, kinder thing: home was never the house, it is the love you carry with you, none of it was your fault, and a heart is big enough for two homes. From The Little Rewrites.' },
