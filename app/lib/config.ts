...
export const KIDS_BOOKS = [
  ...
  },
  {
    ...
    paperback: { price: "$19", href: "/checkout/the-boy-who-talked-to-the-stars?format=paperback" },
    features:  [
      ...
      "A read-aloud tale with a note for grown-ups built in",
      "Complete PDF + Kindle EPUB, plus Lulu-ready 6 x 9 paperback files",
    ],
  ...
  },
  {
    ...
    paperback: { price: "$19", href: "/checkout/the-quietest-kid-in-the-kingdom?format=paperback" },
    features:  [
  ...
  },
  {
    ...
    paperback: { price: "$19", href: "/checkout/the-one-who-sat-alone?format=paperback" },
    features:  [
  ...
  },
  {
    ...
    paperback: { price: "$19", href: "/checkout/the-girl-who-found-her-words?format=paperback" },
    features:  [
  ...
  },
  {
    ...
    paperback: { price: "$19", href: "/checkout/the-kid-with-two-homes?format=paperback" },
    features:  [
