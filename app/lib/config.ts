...
export const EBOOKS = [
  ...
  },
  {
    ...
    features:  [
      ...
      "On grief, survival, and making your own light",
      "Complete PDF + Kindle-ready EPUB",
    ],
    desc: "A raw, luminous memoir about MK Parrish's father: the eleven months that finally gave her a dad after twenty-five years of silence, the texts she now reads like scripture, and the long climb from merely existing back into a life.",
  },
  {
    ...
    features:  [
      ...
      "Written in the REBECOMING voice",
      "Complete PDF + Kindle-ready EPUB",
    ],
    desc: "A short, fierce collection of poems from the dark and the turning toward it. Eleven pieces on loss, survival, and the decision to stop waiting for someone else to light the way.",
  },
  {
    ...
    features:  [
      ...
      "How the body keeps the record, and how to heal",
      "The Rewrite Framework for reclaiming your story",
    ],
    desc: "A clear-eyed guide for anyone who has survived emotional abuse: naming what happened, understanding why you stayed quiet, and a framework for rewriting your life one true line forward.",
  },
  {
    ...
    features:  [
      ...
      "A practical way to make something of it",
      "Journal pages to track your own patterns",
    ],
    desc: "A skeptic's guide to spiritual curiosity. Not a glossary of magical meanings, but a grounded framework for the patterns you keep noticing and what they might be telling you.",
  },
  {
    slug:      "the-vault",
    title:     "The Vault",
