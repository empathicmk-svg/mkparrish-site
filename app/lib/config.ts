...
export const SERVICE_EBOOKS = [
  ...
  },
  {
    ...
    price:     "$18",
    tag:       "Limited Free · Resume",
    highlight: true,
    free:      true,
    limitedFree: true,
    download:  "/downloads/templates/the-resume-rewrite-kit.pdf",
    href:      "/shelf/the-resume-rewrite-kit",
    features:  [
      "Resume positioning audit before you rewrite a word",
      "Summary, experience, and bullet formulas with examples",
      "Achievement bank worksheet for metrics, scope, and proof",
      "Instant download — PDF + EPUB",
    ],
    desc: "A resume rewrite system for people who are tired of underselling the work. Build the proof, sharpen the bullets, and make the page sound like a person worth interviewing.",
  },
  {
    ...
    price:     "$12",
    tag:       "Limited Free · Template",
    highlight: false,
    free:      true,
    limitedFree: true,
    download:  "/downloads/templates/the-clean-resume-template.pdf",
    href:      "/shelf/the-clean-resume-template",
    features:  [
      "One-page resume structure recruiters can scan fast",
      "Copy prompts for summary, role bullets, skills, and proof",
      "Before/after bullet examples that cut vague filler",
      "Instant download — PDF + EPUB",
    ],
    desc: "A clean resume template that keeps the design quiet and makes the proof louder. Built for career pivots, senior operators, creatives, and anyone whose page needs to read better in ten seconds.",
  },
  {
