...
export const metadata: Metadata = {
  ...
  description:
    "Essays on brand voice, marketing economics, and the specific ways smart founders undermine themselves with the words they use. Sharp, practical, and written for people who are done being misread.",
};
