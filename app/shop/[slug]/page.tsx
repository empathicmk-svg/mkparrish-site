...
const extraContent: Record<string, { about: string[]; forWho: string[]; pullQuote: string }> = {
  "rebecoming": {
    about: [
      "REBECOMING: The Latest Model is MK Parrish's flagship memoir, now expanded to eleven present-tense chapters that read like she is in your head, figuring it out alongside you. It opens on a rainy set of church steps, with a QR code and eleven minutes she almost spends walking the other way, and it does not let go.",
